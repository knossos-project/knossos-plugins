...
QT_API_PYTHONQT5 = 'PythonQt5'

ETS = dict(pyqt=(QT_API_PYQTv2, 4), pyside=(QT_API_PYSIDE, 4),
           pyqt5=(QT_API_PYQT5, 5), pythonqt5=(QT_API_PYTHONQT5, 5))
    ...
    try:
        ...
        raise RuntimeError(
            ('Unrecognized environment variable %r, valid values are:'
             ' %r, %r, %r or %r' % (QT_API_ENV, 'pyqt', 'pyside', 'pyqt5', 'pythonqt5')))
...
if QT_API in (QT_API_PYQT, QT_API_PYQTv2, QT_API_PYQT5, QT_API_PYTHONQT5):
    try:
        import sip
        _sip_imported = True
    except ImportError:
...
if QT_API in (QT_API_PYQT, QT_API_PYQTv2, QT_API_PYSIDE, QT_API_PYTHONQT5):
